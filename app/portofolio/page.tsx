    ...
    return (
        <div className="px-6 pt-16 lg:px-24 lg:pt-24 mb-40">
            <section className="hero_section flex flex-col-reverse md:flex-row gap-4 ">
                <div className="md:w-1/3 flex flex-col justify-center">
                    ...
                    <div className="mt-6 mb:mt-16 ">
                        <a href={data?.ui_source} target="_blank" className="default_btn inline-flex items-center justify-center">
            ...
            <section className="mt-16 md:mt-24">
                ...
                <div className="mt-10">
                    <a href={data?.repository_url} target="_blank" className="secound_btn inline-flex items-center justify-center">
                        <svg
